  ...
  return (
    <div className="movie">
      ...
      <div className="mt-10">
        ...
        <div className="flex flex-row space-x-3 mt-5 space-y-20">
        {currentMovieDetail &&
          ...
          currentMovieDetail.characters.map((character) => (
            <>
              {character.name && (
                <span>
                  <img className="w-60 h-60 rounded-md" src={character.image} />
                  <span className="pt-4 mt-4">{character.name}</span>
                </span>
              )}
            </>
          ))}
