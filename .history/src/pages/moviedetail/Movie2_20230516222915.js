          ...
          <div className="flex flex-col-2 flex-wrap px-32 text-center justify-center space-x-6 mt-6">
            {currentMovieDetail &&
              ...
              currentMovieDetail.characters.map((character) => (
                <>
                  {character.name && (
                    <span className="hover:shadow-black hover:transform hover:ease-in-out hover:scale-110 duration-1000 hover:opacity-0.8 hover:box-shadow-rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px; ">
