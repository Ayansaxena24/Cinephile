  ...
  return (
    <div className="movie">
      ...
      <div className="px-52 space-y-2">
        ...
        <div></div>
        <div className="font-bold text-center text-xl pt-4 pb-4 shadow-lg shadow-cyan-400 bg-transparent w-fit flex jus">{currentMovieDetail ? currentMovieDetail.charac : ""}</div>
        <div></div>
