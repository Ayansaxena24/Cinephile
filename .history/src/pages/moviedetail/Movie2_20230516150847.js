    ...
    return (
        ...
        <div className="movie__heading">Production companies</div>
            ...
            <div className="movie__review">
                <div className="movie__reviewHeading">Movie Review</div>
                <div className="movie__synopsis">{currentMovieDetail ? currentMovieDetail.review.synopsis : ""}</div>
                <div className="movie__reviewText">{currentMovieDetail ? currentMovieDetail.review.review : ""}</div>
            </div>
        </div>
    )
}
