...
const Movie2 = () => {
  ...
  return (
    <div className="movie">
      ...
      <div className="px-52 space-y-2 shadow-lg shadow-cyan-300 rounded-3xl mx-10 pb-2">
        <div className="font-bold text-3xl text-center">Review</div>
        <div>{currentMovieDetail ? currentMovieDetail.review1 : ""}</div>
        <div className="flex justify-center">
        <div className="font-bold text-center rounded-3xl px-5 text-xl pt-4 pb-4 shadow-lg shadow-cyan-400 bg-transparent w-fit flex justify-center">{currentMovieDetail ? currentMovieDetail.charac : ""}</div>
        </div>
        <div></div>
