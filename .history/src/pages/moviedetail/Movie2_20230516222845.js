  ...
  return (
    <div className="movie">
      ...
      <div className="mt-10">
        ...
        {/* <div className="grid"> */}
          <div className="flex flex-col-2 flex-wrap px-32 text-center justify-center space-x-6 mt-6 hover:shadow-orange-900">
            {currentMovieDetail &&
              currentMovieDetail.characters &&
              currentMovieDetail.characters.map((character) => (
                <>
                  {character.name && (
                    <span className="hover:transform hover:ease-in-out hover:scale-110 duration-1000 hover:opacity-0.8 hover:box-shadow-rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px; ">
                      <img className="w-80 h-70 rounded-md" src={character.image} />
                      <span className="pt-2 text-center flex justify-center">{character.name}</span>
                    </span>
                  )}
                </>
              ))}
